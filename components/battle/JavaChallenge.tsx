            ...
            <div className="flex-1 flex flex-col p-6 gap-6 overflow-y-auto">
                ...
                <section className="bg-[#111] border-l-4 border-[#FF0033] p-6 shadow-lg">
                    <p className="text-lg text-white mb-4 leading-relaxed">
                        Strict and powerful. Use Java to print to the system console.
                    </p>
                    ...
                    <div className="mb-6">
                        ...
                        <ul className="list-disc list-inside text-sm space-y-2 text-zinc-400">
                            <li>Inside the <span className="text-white bg-white/10 px-1">main</span> method, use <span className="text-[#00F0FF]">System.out.println</span>.</li>
                            <li>Print the string <span className="text-[#FF0033]">"Hello Java"</span>.</li>
                        </ul>
                    </div>
                ...
                <section className="grid grid-cols-2 gap-4 flex-1 min-h-[400px]">
                    ...
                    <div className="flex flex-col h-full">
                        <div className="flex justify-between items-center bg-[#111] px-4 py-2 border-t border-x border-[#333]">
                            <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest">JAVA EDITOR</span>
                    ...
                    <div className="flex flex-col h-full">
                        <div className="flex justify-between items-center bg-[#111] px-4 py-2 border-t border-x border-[#333]">
                            <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest">JVM CONSOLE</span>
                        </div>
                    ...
                    <div className="flex-1 p-4 flex items-center justify-center">
                        {validationStatus === 'idle' && (
                            <p className="text-zinc-500 text-xs font-mono text-center">
                                Write Java code and compile to check output.
                            </p>
                        )}
                        {validationStatus === 'running' && (
                            <div className="flex flex-col items-center gap-2">
                                <div className="w-4 h-4 border-2 border-[#FF0033] border-t-transparent rounded-full animate-spin"></div>
                                <p className="text-[#FF0033] text-xs font-mono animate-pulse">Compiling Bytecode...</p>
                            </div>
                        )}
                        {validationStatus === 'success' && (
                            <div className="flex items-center gap-3 text-green-500 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                ...
                                <div>
                                    <h4 className="font-bold text-sm tracking-wide text-green-400">EXECUTION VERIFIED</h4>
                                    <p className="text-xs opacity-70 font-mono">Found "Hello Java" in output.</p>
                                </div>
                            </div>
                        )}
                    </div>
